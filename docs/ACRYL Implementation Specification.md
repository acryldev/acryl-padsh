# ACRYL Implementation Specification

## Prime Agent × Cordis × DeepSeek Harness Architectural PoC

**Project:** `acryl`  
**Repository:** `inboxxobni/acryl`  
...
| Innovation | Origin | ACRYL action |
|---|---|---|
...
Implement the same property in ACRYL.
...
Therefore ACRYL can remain MIT.
...
That combination is the central research/product hypothesis of ACRYL.
...
If these two rules survive throughout implementation, ACRYL gains the most valuable DSH property — extremely high prefix-cache locality — without giving up Prime's RLM, persistent workers, self-improvement or Pi's extensibility.