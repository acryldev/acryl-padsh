...
ACRYL is an RLM-native coding and research harness built around a persistent Python REPL kernel, recursive subagents, durable sessions, and a multi-process local runtime. It began as a hard fork of pi-mono, but ACRYL is now the product, CLI, install source, and development repository.
...
- [Using ACRYL](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask ACRYL to create them.
...
- [ACRYL packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed ACRYL in Node.js applications.
- [ACP mode](acp.md) - drive ACRYL from any Agent Client Protocol client.
