...
const OWNED_WORKER_ENV = "ACRYL_INTERNAL_OWNED_WORKER";
const OWNED_RECOVERY_DESCRIPTOR_ENV = "ACRYL_INTERNAL_OWNED_RECOVERY_DESCRIPTOR";
const OWNED_PROFILE_ENV = "ACRYL_INTERNAL_OWNED_PROFILE";
...
export async function maybeRunOwnedSessionWorkerFrontend(
	...
	if (!forceLegacyFrontend && process.env.ACRYL_INTERNAL_LEGACY_OWNED_WORKER_FRONTEND !== "1") {
		return false;
	}
