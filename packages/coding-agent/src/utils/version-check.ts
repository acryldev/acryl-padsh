...
const DEFAULT_ACRYL_DOWNLOAD_BASE_URL = "https://pub-728493de92a943e2a9b2d17b4719f318.r2.dev";
...
function getPrimeAgentDownloadBaseUrl(): string {
	return (process.env.ACRYL_DOWNLOAD_BASE_URL?.trim() || DEFAULT_ACRYL_DOWNLOAD_BASE_URL).replace(/\/+$/, "");
}
