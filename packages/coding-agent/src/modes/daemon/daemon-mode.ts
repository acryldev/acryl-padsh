...
const UPDATE_RESTART_MARKER =
	...
	"ACRYL was updated and intentionally interrupted this session. Continue from the saved transcript and restored tool/kernel state. Any running model, tool, bash, or child-agent work may have been partially completed.\n" +
	"</prime_agent_update_interrupted>";
...
export class AgentDaemon {
	...
	async start(): Promise<void> {
		...
		this.log(`ACRYL daemon listening on ${this.socketPath}`);
