...
export async function createAgentSessionServices(
	...
	if (
		...
		diagnostics.push({
			type: "info",
			message:
				"ACRYL sends pseudonymous usage and performance metrics without prompts, responses, tool content, file paths, or repository data. Disable this with telemetry.enabled=false, ACRYL_TELEMETRY=0, DO_NOT_TRACK=1, or offline mode.",
		});
